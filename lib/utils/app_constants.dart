class AppConstants {
  ...
  // static const String BASE_URL = "http://10.0.0.1:8000";
  ...
  static const String ADDRESS_LIST_URI = "/api/v1/cusotmer/address/list";

  static const String GEOCODE_URI = '/api/v1/config/geocode-api';
  static const String ZONE_URI = '/api/v1/config/get-zeno-id';
